...
<body class="hotspot-success-body d-flex align-items-center justify-content-center p-3">
    <main class="hotspot-success-card">
        ...
        <p class="mb-3"><?= esc($nombre) ?>, tu navegacion gratuita fue habilitada correctamente.</p>
        ...
        <?php endif; ?>
        <p class="mb-0">El acceso ya fue autorizado directamente en el MikroTik y la sesion quedo registrada en el sistema.</p>
